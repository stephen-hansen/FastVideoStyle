...
rm results/demo_result_video6.avi
cd videos;
...
cd ..;
python video_demo.py --artistic_optical_flow --fast --nframes 10 --content_video_path videos/video1.mp4 --style_image_path images/style1.png --output_video_path results/demo_result_video6.avi;
