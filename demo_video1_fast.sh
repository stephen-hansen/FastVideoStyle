...
cd ../images;
axel -n 1 https://www.cs.drexel.edu/~sph77/CS583/rooftop.jpg --output=style1.png;
convert -resize 50% style1.png style1.png;
cd ..;
python video_demo.py --content_video_path videos/video1.mp4 --style_image_path images/style1.png --output_video_path results/demo_result_video1.avi;
